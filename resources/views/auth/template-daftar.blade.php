    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              <label class="form-check">
                ...
                <span class="form-check-label">Agree the <a href="{{ asset('themes/tabler') }}/terms-of-service.html" tabindex="-1">terms and policy</a>.</span>
              </label>
            </div>
        ...
        <div class="text-center text-secondary mt-3">
          Already have account? <a href="{{ asset('themes/tabler') }}/sign-in.html" tabindex="-1">Sign in</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
