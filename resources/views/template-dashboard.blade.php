...
<html lang="en">
  ...
  <body >
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <a href="{{ asset('themes/tabler') }}/profile.html" class="dropdown-item">Profile</a>
                <a href="#" class="dropdown-item">Feedback</a>
                <div class="dropdown-divider"></div>
                <a href="{{ asset('themes/tabler') }}/settings.html" class="dropdown-item">Settings</a>
                <a href="{{ asset('themes/tabler') }}/sign-in.html" class="dropdown-item">Logout</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="container-xl">
              <ul class="navbar-nav">
                <li class="nav-item active">
                  <a class="nav-link" href="{{ asset('themes/tabler') }}/" >
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/alerts.html">
                          Alerts
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/accordion.html">
                          Accordion
                        </a>
                        <div class="dropend">
                          ...
                          <div class="dropdown-menu">
                            <a href="{{ asset('themes/tabler') }}/sign-in.html" class="dropdown-item">
                              Sign in
                            </a>
                            <a href="{{ asset('themes/tabler') }}/sign-in-link.html" class="dropdown-item">
                              Sign in link
                            </a>
                            <a href="{{ asset('themes/tabler') }}/sign-in-illustration.html" class="dropdown-item">
                              Sign in with illustration
                            </a>
                            <a href="{{ asset('themes/tabler') }}/sign-in-cover.html" class="dropdown-item">
                              Sign in with cover
                            </a>
                            <a href="{{ asset('themes/tabler') }}/sign-up.html" class="dropdown-item">
                              Sign up
                            </a>
                            <a href="{{ asset('themes/tabler') }}/forgot-password.html" class="dropdown-item">
                              Forgot password
                            </a>
                            <a href="{{ asset('themes/tabler') }}/terms-of-service.html" class="dropdown-item">
                              Terms of service
                            </a>
                            <a href="{{ asset('themes/tabler') }}/auth-lock.html" class="dropdown-item">
                              Lock screen
                            </a>
                            <a href="{{ asset('themes/tabler') }}/2-step-verification.html" class="dropdown-item">
                              2 step verification
                            </a>
                            <a href="{{ asset('themes/tabler') }}/2-step-verification-code.html" class="dropdown-item">
                              2 step verification code
                            </a>
                          </div>
                        </div>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/blank.html">
                          Blank page
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/badges.html">
                          Badges
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/buttons.html">
                          Buttons
                        </a>
                        <div class="dropend">
                          ...
                          <div class="dropdown-menu">
                            <a href="{{ asset('themes/tabler') }}/cards.html" class="dropdown-item">
                              Sample cards
                            </a>
                            <a href="{{ asset('themes/tabler') }}/card-actions.html" class="dropdown-item">
                              Card actions
                              <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                            </a>
                            <a href="{{ asset('themes/tabler') }}/cards-masonry.html" class="dropdown-item">
                              Cards Masonry
                            </a>
                          </div>
                        </div>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/carousel.html">
                          Carousel
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/charts.html">
                          Charts
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/colors.html">
                          Colors
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/colorpicker.html">
                          Color picker
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/datagrid.html">
                          Data grid
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/datatables.html">
                          Datatables
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/dropdowns.html">
                          Dropdowns
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/dropzone.html">
                          Dropzone
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <div class="dropend">
                          ...
                          <div class="dropdown-menu">
                            <a href="{{ asset('themes/tabler') }}/error-404.html" class="dropdown-item">
                              404 page
                            </a>
                            <a href="{{ asset('themes/tabler') }}/error-500.html" class="dropdown-item">
                              500 page
                            </a>
                            <a href="{{ asset('themes/tabler') }}/error-maintenance.html" class="dropdown-item">
                              Maintenance page
                            </a>
                          </div>
                        </div>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/flags.html">
                          Flags
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/inline-player.html">
                          Inline player
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                      </div>
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/lightbox.html">
                          Lightbox
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/lists.html">
                          Lists
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/modals.html">
                          Modal
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/maps.html">
                          Map
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/map-fullsize.html">
                          Map fullsize
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/maps-vector.html">
                          Map vector
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/markdown.html">
                          Markdown
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/navigation.html">
                          Navigation
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/offcanvas.html">
                          Offcanvas
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/pagination.html">
                          <!-- Download SVG icon from http://tabler-icons.io/i/pie-chart -->
                          Pagination
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/placeholder.html">
                          Placeholder
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/steps.html">
                          Steps
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/stars-rating.html">
                          Stars rating
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/tabs.html">
                          Tabs
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/tags.html">
                          Tags
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/tables.html">
                          Tables
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/typography.html">
                          Typography
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/tinymce.html">
                          TinyMCE
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                      </div>
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ asset('themes/tabler') }}/form-elements.html" >
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/empty.html">
                          Empty page
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/cookie-banner.html">
                          Cookie banner
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/chat.html">
                          Chat
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/activity.html">
                          Activity
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/gallery.html">
                          Gallery
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/invoice.html">
                          Invoice
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/search-results.html">
                          Search results
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/pricing.html">
                          Pricing cards
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/pricing-table.html">
                          Pricing table
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/faq.html">
                          FAQ
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/users.html">
                          Users
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/license.html">
                          License
                        </a>
                      </div>
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/logs.html">
                          Logs
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/music.html">
                          Music
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/photogrid.html">
                          Photogrid
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/tasks.html">
                          Tasks
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/uptime.html">
                          Uptime monitor
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/widgets.html">
                          Widgets
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/wizard.html">
                          Wizard
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/settings.html">
                          Settings
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/trial-ended.html">
                          Trial ended
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/job-listing.html">
                          Job listing
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/page-loader.html">
                          Page loader
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                      </div>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-horizontal.html">
                          Horizontal
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-boxed.html">
                          Boxed
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-vertical.html">
                          Vertical
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-vertical-transparent.html">
                          Vertical transparent
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-vertical-right.html">
                          Right vertical
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-condensed.html">
                          Condensed
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-combo.html">
                          Combined
                        </a>
                      </div>
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-navbar-dark.html">
                          Navbar dark
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-navbar-sticky.html">
                          Navbar sticky
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-navbar-overlap.html">
                          Navbar overlap
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-rtl.html">
                          RTL mode
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-fluid.html">
                          Fluid
                        </a>
                        <a class="dropdown-item" href="{{ asset('themes/tabler') }}/layout-fluid-vertical.html">
                          Fluid vertical
                        </a>
                      </div>
                    </div>
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ asset('themes/tabler') }}/icons.html" >
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ asset('themes/tabler') }}/emails.html" >
            ...
            <div class="row text-center align-items-center flex-row-reverse">
              <div class="col-lg-auto ms-lg-auto">
                <ul class="list-inline list-inline-dots mb-0">
                  ...
                  <li class="list-inline-item"><a href="{{ asset('themes/tabler') }}/license.html" class="link-secondary">License</a></li>
              ...
              <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul class="list-inline list-inline-dots mb-0">
                  ...
                  <li class="list-inline-item">
                    <a href="{{ asset('themes/tabler') }}/changelog.html" class="link-secondary" rel="noopener">
                      v1.0.0-beta20
                    </a>
                  </li>
                </ul>
    ...
    <script src="{{ asset('themes/tabler') }}/dist/libs/jsvectormap/dist/maps/world-merc.js?1692870487" defer></script>
    <!-- Tabler Core -->
